...
import { ArrowLeft, Play, Edit, Trash2, Plus, GripVertical, Save, X, Upload, FileText } from 'lucide-react'
...
export default function TeacherCourseViewPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="outline" onClick={() => router.push('/en/dashboard/teacher')}>
